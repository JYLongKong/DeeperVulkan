#ifndef DEEPERVULKAN_SHADERQUEUESUIT_EARTH_H
#define DEEPERVULKAN_SHADERQUEUESUIT_EARTH_H

#include <vector>
#include <vulkan/vulkan.h>

class ShaderQueueSuit_Earth {
 ...
 public:
  ...
  ShaderQueueSuit_Earth(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryroperties);
  ~ShaderQueueSuit_Earth();
};
